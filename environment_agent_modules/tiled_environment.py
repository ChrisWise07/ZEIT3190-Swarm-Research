    ...
    return RegexDict(
        {
            ...
            # top right corner
            f"(0, {(width - 1)})": [WallType.TOP_WALL, WallType.RIGHT_WALL],
            # bottom left corner
            f"({(height - 1)}, 0)": [WallType.BOTTOM_WALL, WallType.LEFT_WALL],
            # bottom right corner
            f"({(height - 1)}, {(width - 1)})": [
            ...
            # right_wall
            f"(., {(width - 1)})": [WallType.RIGHT_WALL],
            # bottom_edge
            f"({(height - 1)}, .)": [WallType.BOTTOM_WALL],
            # all other tiles
            "(., .)": [],
        }
    )

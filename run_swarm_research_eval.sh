#!/bin/bash
export EVAL_MODEL_NAME="random_2_mins_based_on_collective_opinion"
...
export COMMITMENT_THRESHOLD=0.1 #0.025, 0.05, 0.1

export HEIGHT=38
export WIDTH=38
export NUM_OF_SWARM_AGENTS=25 #25
export NUM_EPISODES=10
export MAX_NUM_OF_STEPS=7500 #7500
